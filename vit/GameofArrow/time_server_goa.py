        ...
        with context_manager:
            ...
            while True:
                ...
                if local_i == 2:  # QKV
                    ...
                    s['Q'], s['K'], s['V'] = Q, K, V
                    #i += 1
                    response_state['K'] = s['K']
                    response_state['Q'] = s['Q']
                    response_state['V'] = s['V']
                    break
                
                elif local_i == 3: # Scores
                    Q = s['Q']
                    K = s['K']
                    if self.use_cuda:
                        s['scores'] = torch.matmul(Q, K.transpose(-2, -1)) / math.sqrt(self.d_k)
                        S_q = Q.shape[2]
                        ...
                        s['scores'] += mask[None, None, :, :]
                    response_state['scores'] = s['scores']
                    break
                    #i += 1
