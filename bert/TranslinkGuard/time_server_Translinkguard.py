...
class TransformerService(demo_pb2_grpc.TransformerServiceServicer):
    def __init__(self, device_choice: str = "cpu"):
        ...
        try:
            data = np.load('bert_server_params.npz')
        except FileNotFoundError:
            raise FileNotFoundError("bert_server_params.npz not found. Run download_bert_params.py first.")
        ...
        client_data = np.load('bert_params/params.npz') 
